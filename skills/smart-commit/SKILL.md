...
**Attribution footer:** follow the host repo's convention. If the repo's
CLAUDE.md (or the harness) mandates a `Co-Authored-By` footer, include it
exactly as specified; otherwise add no AI attribution footer.
